...
In the UI (accessible at https://confluent.ext.127-0-0-1.nip.io/), navigate to the `csfle` topic ([Direct Link](https://confluent.ext.127-0-0-1.nip.io/clusters/confluentplatform-demo/management/topics/csfle/message-viewer))
